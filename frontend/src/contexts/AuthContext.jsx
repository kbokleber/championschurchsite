  ...
  const loadUser = async () => {
    try {
      ...
      if (!userData.is_superuser) {
        ...
        userData.menus_permitidos = ['dashboard', 'eventos', 'membros', 'inscricoes', 'cobrancas', 'checkin', 'sorteio', 'contatos', 'categorias', 'configuracoes', 'usuarios', 'grupos', 'formularios_inscricao', 'loja', 'backup_import']
      }
